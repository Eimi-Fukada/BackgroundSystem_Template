...
const Component: FC<PersonalCenterProps> = () => {
  const { visible, setVisible, handleOk, onValuesChange } = ViewModel();
  ...
  return (
    <div className={styles.page}>
      <div className={styles.content}>
        <Avatar size={64} className={styles.avatar} src={currentUser.avatar} alt="avatar" />
        <span className={styles.name}>{currentUser.name}</span>
        <div className={styles.btnGroup}>
          <Button onClick={() => setVisible(true)} style={{ borderRadius: '20px' }} size={'large'}>
            修改密码
          </Button>
          <Button
            type="primary"
